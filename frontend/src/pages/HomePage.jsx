...
const categoryIcons = {
    ...
    'fashion pria': (
        <svg className="w-6 h-6 text-blue-700" fill="currentColor" viewBox="0 0 16 16">
    ...
    'furniture': (
        <svg className="w-6 h-6 text-amber-600" fill="currentColor" viewBox="0 0 16 16">
            <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5z"/>
        </svg>
    ),
    'gadget': (
        <svg className="w-6 h-6 text-slate-600" fill="currentColor" viewBox="0 0 16 16">
    ...
    'hobi & kerajinan': (
        <svg className="w-6 h-6 text-teal-600" fill="currentColor" viewBox="0 0 16 16">
        ...
        const fetchHomePageData = async () => {
            try {
                ...
                if (err.response)
                    ...
                    msg = 'Tidak dapat terhubung ke server. Pastikan server backend berjalan dan konfigurasi CORS sudah benar.';
                    ...
                    <div className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-4">
                        <Link to="/" className="group">
                            <div className="flex flex-col items-center p-4 rounded-lg hover:bg-gray-50 transition-colors">
                                ...
                                <span className="text-sm font-medium text-gray-700 text-center">Semua Kategori</span>
                            </div>
                        </Link>
