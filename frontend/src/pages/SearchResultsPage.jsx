...
function SearchResultsPage() {
  ...
  useEffect(() => {
    ...
    const fetchSearchResults = async () => {
      ...
      try {
        ...
        setSearchResults(response.data.data || response.data); // Adjust based on API response
        setError(null);
      } catch (err) {
  ...
  if (loading) {
    return <div className="container mx-auto px-4 py-8 text-center">Mencari produk...</div>;
  }
