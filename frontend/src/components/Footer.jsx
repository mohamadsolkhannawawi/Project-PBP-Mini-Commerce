        ...
        <footer style={{ backgroundColor: '#1B263B' }} className="text-white">
            <div className="container mx-auto px-6 py-10">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
                    ...
                    <div>
                        <h3 className="font-bold text-lg mb-2 font-montserrat">TokoKita</h3>
                        <p className="text-gray-400">
                            TokoKita adalah platform e-commerce terpercaya yang menyediakan berbagai macam produk berkualitas untuk memenuhi kebutuhan harian Anda.
                        </p>
                    </div>
                ...
                <div className="border-t border-gray-600 mt-8 pt-6 text-center text-gray-500">
                    <p>&copy; {new Date().getFullYear()} TokoKita. Semua Hak Cipta Dilindungi.</p>
                </div>
            </div>
        </footer>
    );
